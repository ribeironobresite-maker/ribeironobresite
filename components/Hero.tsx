    ...
    <section className="hero-grad text-light relative">
      <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-12 gap-10 items-center">
        ...
        <div className="md:col-span-5 hidden md:block">
          <div
            className={`${
              useImage ? "aspect-[4/5]" : "aspect-square"
            } rounded-2xl overflow-hidden border shadow-2xl relative`}
            style={{
            ...
            {useImage ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center p-16 lg:p-20">
                <Image
                  ...
                  height={260}
                  priority
                  className="hero-logo w-full h-auto max-w-[240px] lg:max-w-[260px] object-contain"
                  style={{
