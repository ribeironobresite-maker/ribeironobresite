...
const SCOPE_ITEMS = [
  "Direito Cível (indenizações, contratos, locação)",
  "Direito do Consumidor (cobranças abusivas, negativações, planos de saúde, bancos)",
  "Direito Trabalhista (defesa e consultoria)",
  "Atendimento técnico e direto com o advogado",
];
...
export default function WhatsAppCTA({
  ...
  const wa = officeData?.whatsapp ?? site.primaryWhatsapp;
