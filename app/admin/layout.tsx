...
// Admin lê cookie de sessão a cada request — sempre dinâmico.
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <nav className="flex items-center gap-5 text-sm text-dark">
            ...
            <Link href="/admin/livros" className="hover:opacity-70">
              Livros
            </Link>
            <Link href="/admin/artigos" className="hover:opacity-70">
              Artigos
            </Link>
            <Link href="/admin/contato" className="hover:opacity-70">
              Contato
            </Link>
            <Link
              href="/"
